  ...
  return (
    <div className="min-h-screen w-full bg-white p-8 text-gray-900">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Skill Table Section */}
        <div className="rounded-2xl shadow-xl p-6 border border-gray-200 overflow-x-auto bg-white">
              ...
              {[
                ...
                >
                  <td
                    ...
                    style={{ color: "hsl(213.3, 96.9%, 40%)" }}
                  >
                    {item.rank}
                  </td>
                  <td className="py-3 px-4">{item.skill}</td>
                  <td className="py-3 px-4 font-semibold" style={{ color: "hsl(213.3, 96.9%, 40%)" }}>
                    {item.growth}
                  </td>
                </tr>
              ))}
